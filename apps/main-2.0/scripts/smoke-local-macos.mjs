...
try {
  ...
  const report = { status: "PASS", state, menus, postgres, readiness, isolation: "explicit paths + sandbox real-home deny + loopback-only", manual: ["Dock label", "Finder double-click"], testRoot };
  if (uiQuality) {
